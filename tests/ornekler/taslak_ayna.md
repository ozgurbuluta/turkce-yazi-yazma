...
Ancak verimlilik verileri karışık. Nicholas Bloom liderliğindeki bir Stanford çalışması, hibrit çalışanların ofisteki meslektaşları kadar üretken olduğunu ve işten ayrılma olasılıklarının %35 daha düşük olduğunu buldu. Çalışma, Trip.com'daki 1.600 çalışanı iki yıl boyunca takip etti. Microsoft'un benzer bir araştırması da verimliliğin %20 arttığını gösterdi.

Muhtemel sonuç kalıcı bir bölünme: bazı şirketler tamamen uzaktan, bazıları tamamen ofiste olacak ve çoğu ikisinin arasında bir yerde karar kılacak.
