...
|---|---|---|---|---|
| [Leipzig Corpora Collection](https://wortschatz.uni-leipzig.de/en/download/Turkish) — `tur_news_2024_30K` | Haber cümleleri ve sözcük sıklığı | CC BY 4.0 | Sözcük listesi kırpılmış halde `skills/turkce-yazi/data/siklik_yazili.tsv`; cümle dosyası değil | `tools/fetch_data.sh` indirir; atıf: Goldhahn, Eckart, Quasthoff, LREC 2012 |
