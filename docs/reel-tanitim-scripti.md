...
Önce kalıp listeleri: 111 Türkçe yapay zekâ kalıbı, 71 çeviri kokusu kalıbı; her birinin yanında ne yapılacağı yazıyor (`skills/turkce-editor/data/ai_kaliplari.tsv`: 111 kalıp, 6 kategori; `ceviri_kokusu.tsv`: 71 kalıp, 10 kategori; elle derlendi, MIT).
